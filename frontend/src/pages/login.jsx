  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post(
        ...
        { email, password },
        {
          withCredentials: true, // So cookie (JWT) is stored
        }
      );
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-6">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-blue-500">
          ...
          <a
            href="#"
            className="font-medium text-blue-500 hover:underline transition"
          >
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {message && (
            <div className="text-sm text-center text-red-500 mb-4">
              {message}
            </div>
          )}
