...
const ProjectPartners = () => {
  ...
  // Filter for project partners
  const projectPartners = partners?.filter(partner => 
    partner.partnershipRequestType === "project"
  ) || [];
        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-3xl font-bold text-[#3c8dbc]">Project Partnerships</h2>
                <p className="mt-1 text-sm text-gray-600">List of all project partnerships</p>
              </div>
            </div>
          </div>
          ...
          {projectPartners.length === 0 ? (
            <div className="bg-gray-50 p-6 rounded-lg text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No project partnerships found</h3>
              <p className="mt-1 text-sm text-gray-500">There are currently no project partnerships.</p>
            </div>
          ) : (
