...
const TacticalPartners = () => {
  ...
  // Filter for tactical partners
  const tacticalPartners = partners?.filter(partner => 
    partner.partnershipRequestType === "tactical"
  ) || [];
        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-3xl font-bold text-[#3c8dbc]">Tactical Partnerships</h2>
                <p className="mt-1 text-sm text-gray-600">List of all tactical partnerships</p>
              </div>
            </div>
          </div>

          {tacticalPartners.length === 0 ? (
            <div className="bg-gray-50 p-6 rounded-lg text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No tactical partnerships found</h3>
              <p className="mt-1 text-sm text-gray-500">There are currently no tactical partnerships.</p>
            </div>
          ) : (
...
export default TacticalPartners; 